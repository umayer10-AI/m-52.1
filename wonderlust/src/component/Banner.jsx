...
const Banner = () => {
  return (
    <div className="bg-[url('/assets/banner.png')] text-white rounded-xl overflow-hidden flex justify-between flex-col items-center gap-5 h-[60vh]">
      <div className="p-10 text-center flex justify-center flex-col items-center gap-3.5 flex-1">
        ...
        <div className="flex gap-5">
          <button className="uppercase bg-cyan-500 px-5 py-3 rounded-xl cursor-pointer">
            Explore Now
          </button>

          <button className="uppercase px-5 py-3 rounded-xl bg-white/50 cursor-pointer">
            View Destination
          </button>
        </div>
      </div>
